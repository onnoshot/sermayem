  ...
  return (
    <div className="relative h-[440px] sm:h-[520px] lg:h-[580px] w-full">
      ...
      <motion.div
        ...
        style={{ right: "clamp(40px, 10%, 56px)" }}
      >
        <motion.div
          animate={{ y: [0, -10, 0] }}
          transition={{ duration: 7, repeat: Infinity, ease: "easeInOut" }}
          className="p-5 sm:p-6 rounded-[22px] sm:rounded-[26px]"
          style={{
          ...
          <div className="flex items-start justify-between mb-4">
            <div>
              ...
              <div className="flex items-baseline gap-1.5">
                <span className="text-[2rem] sm:text-[2.4rem] font-black text-white leading-none">142.850</span>
                <span className="text-base sm:text-lg font-semibold text-white/28">TL</span>
              </div>
            </div>
            <div className="h-10 w-10 sm:h-11 sm:w-11 rounded-[13px] flex items-center justify-center text-xl"
      ...
      <motion.div
        ...
        className="absolute bottom-6 right-0 w-[175px] sm:w-[210px] z-20"
      >
        <motion.div
          animate={{ y: [0, 10, 0] }}
          transition={{ duration: 6, repeat: Infinity, ease: "easeInOut", delay: 1.5 }}
          className="p-3.5 sm:p-4 rounded-[18px]"
          style={{
        ...
        >
          <p className="text-[9px] sm:text-[10px] text-white/25 mb-2.5 uppercase tracking-wider">Son İşlemler</p>
          <div className="space-y-2">
            {MOCK_TXS.map((t) => (
              <div key={t.name} className="flex items-center gap-2">
                <div className="h-6 w-6 rounded-[7px] bg-white/[0.05] flex items-center justify-center text-xs flex-shrink-0">{t.emoji}</div>
                <span className="text-[10px] sm:text-[11px] text-white/50 flex-1 truncate">{t.name}</span>
                <span className="text-[10px] sm:text-[11px] font-semibold tabular-nums" style={{ color: t.pos ? "#4ADE80" : "#F87171" }}>{t.amount}</span>
              </div>
            ))}
          </div>
        </motion.div>
      ...
      <motion.div
        ...
        style={{ top: "-14px", right: "clamp(48px, 14%, 72px)" }}
      >
        <motion.div
          animate={{ y: [0, -6, 0] }}
          transition={{ duration: 3.8, repeat: Infinity, ease: "easeInOut", delay: 0.8 }}
          className="px-2.5 sm:px-3 py-1.5 rounded-[10px] flex items-center gap-2"
          style={{
      ...
      <motion.div
        ...
        className="absolute bottom-0 left-0 sm:left-3 z-30"
      >
        <motion.div
          animate={{ y: [0, -6, 0] }}
        ...
        >
          <div className="h-7 w-7 rounded-[8px] bg-green-500/15 flex items-center justify-center text-sm flex-shrink-0">📈</div>
          <div>
            <p className="text-[9px] sm:text-[10px] text-white/25 leading-none mb-0.5">Aylık hedef</p>
            <p className="text-[12px] sm:text-[13px] font-bold text-green-400">72% tamamlandı</p>
          </div>
        </motion.div>
      </motion.div>
    </div>
  ...
  return (
    <main className="min-h-screen bg-[#08080C] text-white overflow-x-hidden">
      ...
      <div className="fixed inset-0 -z-10 pointer-events-none overflow-hidden">
        <motion.div
          className="absolute -top-[25%] -left-[20%] h-[900px] w-[900px] rounded-full"
        ...
        />
        <motion.div
          className="absolute top-[40%] left-[30%] h-[600px] w-[600px] rounded-full"
          style={{ background: "radial-gradient(circle, rgba(124,58,237,0.03), transparent 70%)" }}
      ...
      >
        <div className="max-w-6xl mx-auto px-5 sm:px-8 h-16 flex items-center justify-between">
          ...
          <img src="/sermayem.svg" alt="Sermayem" className="h-[22px] object-contain" />
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="/auth/signup"
              className="flex items-center gap-1.5 text-sm font-bold text-white px-4 py-2 rounded-[11px] transition-all active:scale-[0.96]"
      ...
      {/* ─── HERO ─── */}
      <section ref={heroRef} className="max-w-6xl mx-auto px-5 sm:px-8 pt-14 sm:pt-20 lg:pt-24 pb-12 lg:pb-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div>
              ...
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-green-500/20 bg-green-500/[0.07] mb-6"
              >
              ...
              <motion.h1
                ...
                className="text-[2.6rem] sm:text-[3.4rem] lg:text-[3.8rem] xl:text-[4.2rem] font-black leading-[1.04] tracking-tight mb-5"
              >
              ...
              <motion.p
                ...
                className="text-[16px] sm:text-[17px] text-white/42 leading-relaxed mb-8 max-w-[500px]"
              >
              ...
              >
                <Link href="/auth/signup"
                  className="flex items-center justify-center gap-2 px-7 py-3.5 rounded-[15px] font-bold text-white text-[15px] transition-all active:scale-[0.97]"
                  style={{
                ...
                <Link href="/auth/login"
                  className="flex items-center justify-center gap-2 px-7 py-3.5 rounded-[15px] font-semibold text-white/65 text-[15px] border border-white/[0.09] bg-white/[0.04] hover:bg-white/[0.07] hover:text-white/85 transition-all">
                  Giriş Yap
                </Link>
              </motion.div>
              ...
              >
                {[
                  ...
                  { icon: "0₺", text: "Tamamen ücretsiz" },
                ].map((t) => (
                  <div key={t.text} className="flex items-center gap-1.5 text-[12px] text-white/30">
            ...
            {/* Right — Product mockup (hidden on mobile, shown on lg+) */}
      ...
      {/* ─── FEATURES ─── */}
      <section id="ozellikler" className="max-w-6xl mx-auto px-5 sm:px-8 py-16 sm:py-24">
        <motion.div
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-[3.2rem] font-black text-white tracking-tight mb-4">
            Her şey tek bir yerde
          </h2>
          <p className="text-white/38 text-[16px] max-w-[440px] mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {FEATURES.map((f, i) => (
            <motion.div
              ...
              className="relative p-6 sm:p-7 rounded-[24px] overflow-hidden group cursor-default"
              style={{
                background: f.bg,
            ...
            >
              ...
              <h3 className="text-[17px] font-bold text-white mb-2.5">{f.title}</h3>
      ...
      {/* ─── SECURITY ─── */}
      <section id="guvenlik" className="max-w-6xl mx-auto px-5 sm:px-8 py-16 sm:py-24">
        <motion.div
          initial={{ opacity: 0, y: 24 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="relative rounded-[28px] sm:rounded-[36px] overflow-hidden p-8 sm:p-12 lg:p-16"
          style={{
        ...
        >
          ...
          <div className="absolute -bottom-16 -left-16 h-56 w-56 rounded-full pointer-events-none"
            style={{ background: "radial-gradient(circle, rgba(34,197,94,0.05), transparent 70%)" }} />

          <div className="relative">
            <div className="flex items-center gap-3 mb-8">
              <div className="h-11 w-11 rounded-[13px] bg-green-500/15 border border-green-500/20 flex items-center justify-center text-xl">🔒</div>
              <div>
                <p className="text-xs text-green-400/65 uppercase tracking-[0.18em] font-medium mb-0.5">Güvenlik</p>
                <h2 className="text-2xl sm:text-3xl font-black text-white">Verileriniz güvende</h2>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              {SECURITY.map((s, i) => (
                <motion.div
                  ...
                  className="flex items-start gap-3.5 p-4 sm:p-5 rounded-[18px]"
      ...
      <section className="max-w-6xl mx-auto px-5 sm:px-8 py-16 sm:py-24">
        <motion.div
          ...
          className="relative text-center rounded-[28px] sm:rounded-[36px] p-10 sm:p-16 overflow-hidden"
          style={{
        ...
        >
          ...
          <div className="relative">
            ...
            <p className="text-white/38 text-[16px] mb-8 max-w-[380px] mx-auto leading-relaxed">
              Hesap oluşturmak ücretsiz. Kredi kartı gerekmez. Hemen başla.
            </p>
            <Link href="/auth/signup"
              className="inline-flex items-center gap-2.5 px-8 sm:px-10 py-3.5 sm:py-4 rounded-[17px] font-bold text-white text-[16px] transition-all active:scale-[0.97] hover:opacity-92"
              style={{
                background: "linear-gradient(135deg,#E50001,#CC0001)",
